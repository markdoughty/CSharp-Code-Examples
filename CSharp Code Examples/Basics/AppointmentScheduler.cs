...
{
    //Authors: Wilfred-126
    //An appointment scheduler for solving daily needs
    public class AppointmentScheduler
    {
        ...
        //Authors: Wilfred-126
        //Static method which will run the code in the program.cs 
        ...
        //Authors: Wilfred-126
        //Static method for scheduling the appointments by getting the desired details
        ...
        //Authors: Wilfred-126
        //Static method to view all the scheduled appointments
        ...
        //Authors: Wilfred-126
        //Static method to update an appointment already saved
        ...
        //Authors: Wilfred-126
        //Static method to delete the appointment from the list of Appointments
        static void DeleteAppointment()
        {
            ...
            ViewAppointments();
            Console.Write("Enter the appointment number to delete: ");
            if (!int.TryParse(Console.ReadLine(), out int index) || index < 1 || index > appointments.Count)
            {
                Console.WriteLine("Invalid appointment number. Deletion cancelled.");
                return;
            }
    ...
    /// <summary>
    /// This class will act as a Model for the Appointment Scheduler
    /// </summary>
    public class Appointment
    {
        ...
        //Author: Wilfred-126
        //A constructor for initializing the appointment object
        ...
        //Author: Wilfred-126
        //A method to override the default ToString() method for dispalying the object
